...
//        BmobQuery<Resturant> query = new BmobQuery();
//        query.findObjects(new FindListener<Resturant>() {
//            @Override
//            public void done(List<Resturant> object, BmobException e) {
//                if (e == null) {
//                    if (object.size() > 0) {
//                        for (Resturant allenDemo : object) {
//                            BLog.e(allenDemo.toString());
//                        }
//                    }
//                } else {
//                    Log.e("", e.toString());
...
//        });
        ...
        bmobQuery.addWhereEqualTo("age", 2115);
