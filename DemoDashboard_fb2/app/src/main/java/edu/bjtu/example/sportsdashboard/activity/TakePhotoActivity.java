...
import edu.bjtu.example.sportsdashboard.adapter.PhotoFiltersAdapter;
import edu.bjtu.example.sportsdashboard.view.RevealBackgroundView;

public class TakePhotoActivity extends MainActivity implements RevealBackgroundView.OnStateChangeListener,
        CameraHostProvider {
